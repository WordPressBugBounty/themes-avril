...
( function ( $ ) {
    ...
    wp.customize(
        'breadcrumb_min_height', function ( value ) {
            value.bind(
                function ( size ) {
     ...
     */
    wp.customize(
        'avril_body_font_size', function ( value ) {
            value.bind(
                function ( size ) {
     ...
     */
    wp.customize(
        'avril_body_font_style', function ( value ) {
            value.bind(
                function ( font_style ) {
     ...
     */
    wp.customize(
        'avril_body_text_transform', function ( value ) {
            value.bind(
                function ( text_tranform ) {
    ...
    wp.customize(
        'avril_body_line_height', function ( value ) {
            value.bind(
     ...
     */
    wp.customize(
        'avril_h1_font_family', function ( value ) {
            value.bind(
     ...
     */
    wp.customize(
        'avril_h1_font_size', function ( value ) {
            value.bind(
                function ( size ) {
     ...
     */
    wp.customize(
        'avril_h1_font_style', function ( value ) {
            value.bind(
                function ( font_style ) {
     ...
     */
    wp.customize(
        'avril_h1_text_transform', function ( value ) {
            value.bind(
                function ( text_tranform ) {
     ...
     */
    wp.customize(
        'avril_h1_line_height', function ( value ) {
            value.bind(
                function ( line_height ) {
     ...
     */
    wp.customize(
        'avril_h2_font_family', function ( value ) {
            value.bind(
                function ( font_family ) {
     ...
     */
    wp.customize(
        'avril_h2_font_size', function ( value ) {
            value.bind(
                function ( size ) {
     ...
     */
    wp.customize(
        'avril_h2_font_style', function ( value ) {
            value.bind(
                function ( font_style ) {
     ...
     */
    wp.customize(
        'avril_h2_text_transform', function ( value ) {
            value.bind(
                function ( text_tranform ) {
     ...
     */
    wp.customize(
        'avril_h2_line_height', function ( value ) {
            value.bind(
                function ( line_height ) {
     ...
     */
    wp.customize(
        'avril_h3_font_family', function ( value ) {
            value.bind(
                function ( font_family ) {
     ...
     */
    wp.customize(
        'avril_h3_font_size', function ( value ) {
            value.bind(
                function ( size ) {
     ...
     */
    wp.customize(
        'avril_h3_font_style', function ( value ) {
            value.bind(
                function ( font_style ) {
     ...
     */
    wp.customize(
        'avril_h3_text_transform', function ( value ) {
            value.bind(
                function ( text_tranform ) {
     ...
     */
    wp.customize(
        'avril_h3_line_height', function ( value ) {
            value.bind(
                function ( line_height ) {
     ...
     */
    wp.customize(
        'avril_h4_font_family', function ( value ) {
            value.bind(
                function ( font_family ) {
     ...
     */
    wp.customize(
        'avril_h4_font_size', function ( value ) {
            value.bind(
                function ( size ) {
     ...
     */
    wp.customize(
        'avril_h4_font_style', function ( value ) {
            value.bind(
                function ( font_style ) {
     ...
     */
    wp.customize(
        'avril_h4_text_transform', function ( value ) {
            value.bind(
                function ( text_tranform ) {
     ...
     */
    wp.customize(
        'avril_h4_line_height', function ( value ) {
            value.bind(
                function ( line_height ) {
     ...
     */
    wp.customize(
        'avril_h5_font_family', function ( value ) {
            value.bind(
                function ( font_family ) {
     ...
     */
    wp.customize(
        'avril_h5_font_size', function ( value ) {
            value.bind(
                function ( size ) {
     ...
     */
    wp.customize(
        'avril_h5_font_style', function ( value ) {
            value.bind(
                function ( font_style ) {
     ...
     */
    wp.customize(
        'avril_h5_text_transform', function ( value ) {
            value.bind(
                function ( text_tranform ) {
     ...
     */
    wp.customize(
        'avril_h5_line_height', function ( value ) {
            value.bind(
                function ( line_height ) {
     ...
     */
    wp.customize(
        'avril_h6_font_family', function ( value ) {
            value.bind(
                function ( font_family ) {
     ...
     */
    wp.customize(
        'avril_h6_font_size', function ( value ) {
            value.bind(
                function ( size ) {
     ...
     */
    wp.customize(
        'avril_h6_font_style', function ( value ) {
            value.bind(
                function ( font_style ) {
     ...
     */
    wp.customize(
        'avril_h6_text_transform', function ( value ) {
            value.bind(
                function ( text_tranform ) {
     ...
     */
    wp.customize(
        'avril_h6_line_height', function ( value ) {
            value.bind(
                function ( line_height ) {
