...
(function ( $, avrilConfig ) {
    ...
    AvrilThemeJs = {
        ...
        menuFocusAccessibility: function ( event ) {
            $('.menubar, .widget_nav_menu').find('a').on(
                'focus blur', function () {
        ...
        customQuery: function () {
            ...
            function animateHeadline($headlines)
            {
                ...
                $headlines.each(
                    function () {
                        ...
                        setTimeout(
                            function () {
                                hideWord(headline.find('.is-show').eq(0)) }, duration
                        );
                    }
                );
            }
            ...
            function hideWord($word)
            {
                ...
                setTimeout(
                    function () {
                        hideWord(nextWord) }, animationDelay
                );
            }
            //Hide Letter
            function hideLetter($letter, $word, $bool, $duration)
            {
                ...
                if(!$letter.is(':last-child')) {
                    setTimeout(
                        function () {
                            hideLetter($letter.next(), $word, $bool, $duration); }, $duration
                    );  
                } else if($bool) { 
                    setTimeout(
                        function () {
                            hideWord(takeNext($word)) }, animationDelay
                    );
                }
