...
if (! class_exists('Avril_Customizer') ) {
    ...
    class Avril_Customizer
    {
        ...
        function avril_customizer_register( $wp_customize )
        {
             ...
             * Helper files
             */
            include AVRIL_PARENT_INC_DIR . '/custom-controls/font-control.php';
            include AVRIL_PARENT_INC_DIR . '/sanitization.php';
        }
        ...
        {    
            include AVRIL_PARENT_INC_DIR . '/customize/avril-header.php';
            include AVRIL_PARENT_INC_DIR . '/customize/avril-blog.php';
            include AVRIL_PARENT_INC_DIR . '/customize/avril-footer.php';
            include AVRIL_PARENT_INC_DIR . '/customize/avril-general.php';
            include AVRIL_PARENT_INC_DIR . '/customize/customizer_recommended_plugin.php';
            include AVRIL_PARENT_INC_DIR . '/customize/customizer_import_data.php';
            include AVRIL_PARENT_INC_DIR . '/customize/avril-premium.php';
        }
