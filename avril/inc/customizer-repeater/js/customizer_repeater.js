...
jQuery(document).ready(
    function () {
        ...
        avril_theme_controls.on(
            'change','.customizer-repeater-slide-align', function () {
                avril_customizer_repeater_refresh_general_control_values();
                return false;
        ...
        avril_theme_controls.on(
            'change','.customizer-repeater-image2-control', function () {
                avril_customizer_repeater_refresh_general_control_values();
                return false;
            ...
            'click', '.customizer-repeater-new-field', function () {
                ...
                if (typeof th !== 'undefined') {
                    ...
                    if (typeof field !== 'undefined') {
                        ...
                        field.find('.input-group-addon').html('<i class="fa"></i>');
